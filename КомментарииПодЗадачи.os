...
Процедура ОбновитьШаблон()    //&filter[!REAL_STATUS]=5
...
Результат = Клиент.Получить("/rest/13083/" + Токен + "/tasks.task.list?filter[RESPONSIBLE_ID]=" + ID + "&select[0]=ID&select[1]=TITLE");
